...
export class HelmSettingTab extends PluginSettingTab {
  ...
  private renderPlanning(body: HTMLElement): void {
    ...
    this.text(writing.content, 'followupTag', { name: 'Follow-up tag', desc: 'Offered as a toggle in “Follow up…” (never added on its own), without the #.', placeholder: 'followup', fallback: 'followup' });
