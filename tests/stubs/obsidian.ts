...
export class TextComponent { inputEl: HTMLInputElement; private cb?: (v: string) => unknown; constructor(el: HTMLElement) { this.inputEl = el.createEl('input', { type: 'text' }) as HTMLInputElement; this.inputEl.addEventListener('input', () => this.cb?.(this.inputEl.value)); } setDisabled(d: boolean): this { this.inputEl.disabled = d; return this; } setPlaceholder(p: string): this { this.inputEl.placeholder = p; return this; } setValue(v: string): this { this.inputEl.value = v; return this; } getValue(): string { return this.inputEl.value; } onChange(cb: (v: string) => unknown): this { this.cb = cb; return this; } }
