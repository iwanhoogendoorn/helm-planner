...
describe('dashboard stats', () => {
  it('computes totals, series and drilldowns over the fixture', async () => {
    ...
    const s = computeStats(index.snapshot, { from: '2026-08-20', to: TODAY }, TODAY, settings);
    ...
    const a = computeStats(index.snapshot, { from: '2026-08-20', to: TODAY, area: 'Oracle' }, TODAY, settings);
